...
| `qk rebase [branch]` | Conflict-aware rebase with lockfile auto-regeneration (pre-checks via merge-tree, auto-reinstalls lockfile-only conflicts) |
| `qk gpr` | AI-powered Pull Request generator (optional: `qk gpr "<extra LLM instructions>"`) |
